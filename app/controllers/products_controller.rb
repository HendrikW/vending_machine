...
class ProductsController < ApplicationController
  ...
  before_action :user_is_seller, except: %i[index show buy] # buyers can only look, not modify products
  ...
  def buy
    ...
    render json: {
      funds_spent: total_cost,
      purchased_product: product.product_name,
      availabe_change: current_user.availabe_change
    }
  end
